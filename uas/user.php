...
if (isset($_POST['simpan']))
{
    ...
    {
        $check_pengguna = "SELECT * FROM `user` WHERE username = ? AND id != ?";
        ...
        {
            $update_data = "UPDATE `user` SET username = ?, password = ?, nama_admin = ? WHERE id = ?";
...
if (isset($_POST['tambah']))
{
    ...
    {
        $check_pengguna = "SELECT * FROM `user` WHERE username = ?";
        $check_pengguna = $connect->prepare($check_pengguna);
        ...
        {
            $update_data = "INSERT INTO `user` SET username = ?, password = ?, nama_admin = ?";
            $update_data = $connect->prepare($update_data);
            $update_data->execute([
                $username,
                $password,
...
{
    $id = $_GET['id'];
    $nonaktifkan = "UPDATE `user` SET status_aktif = ? WHERE id = ? AND id != ?";
                ...
                <div class="col-md-3">
                    <form method="post">
                        ...
                        <?php if (isset($_GET['act']) && $_GET['act'] == 'edit'):
                            $id = $_GET['id'];
                            $check_user = "SELECT * FROM `user` WHERE id = ?";
                ...
                <div class="col-md-9">
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            $check_user = "SELECT * FROM `user` ORDER BY id ASC";
                            $check_user = $connect->prepare($check_user);
                            $check_user->execute();
