...
$id = $_GET['id'];
$check_data = "SELECT * FROM `pengiriman` WHERE id = ?";
...
if (isset($_POST['tambah']))
{
    ...
    $insert_data = "INSERT INTO `pengiriman_detail` SET nomor_resi = ?, tanggal = ?, kota = ?, keterangan = ?";
        ...
        <div class="content-web my-5">
            ...
            <table class="table my-5 table-bordered">
                ...
                <tbody>
                    ...
                    $check_list = "SELECT * FROM `pengiriman_detail` WHERE nomor_resi = ?";
