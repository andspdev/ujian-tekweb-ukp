...
if (isset($_POST['tambah']))
{
    ...
    $check_nomor = $connect->prepare("SELECT * FROM pengiriman WHERE nomor_resi = ?");
    ...
    {
        $insert_data = "INSERT INTO `pengiriman` SET nomor_resi = ?, tanggal_resi = ?";
        ...
        <div class="content-web my-5">
            ...
            <div class="col-md-3">
                <form method="post">
                    ...
                    if (isset($msg) && $_GET['msg'] == 'berhasil_ditambahkan'): ?>
                    ...
                    <p>Tanggal</p>
                    <input type="date" name="tanggal" class="form-control form-control-lg"><br />

                    <p>Nomor Resi</p>
                    <input type="text" name="nomor_resi" class="form-control form-control-lg"><br />
            ...
            <table class="table my-5 table-bordered">
                ...
                <tbody>
                    ...
                    $check_data = "SELECT * FROM `pengiriman` ORDER BY tanggal_resi ASC";
